...
void* connection_handler(int socket_desc) {    
    ...
    msg_len = strlen(buf);
    /** INSERT CODE TO SEND WELCOME MESSAGE TO THE CLIENT
     *
     * Suggestions:
    ...
    while (1) {
         ...
         */
         ...
         recv_bytes = recv(socket_desc, buf, buf_len - 1, 0);

        // check if either I have just been told to quit...
        /** INSERT CODE HERE TO ANALYZE THE RECEIVED MESSAGE
         *
         * Suggestions:
         ...
         */
         ...
         if (recv_bytes == quit_command_len &&
                 !memcmp(buf, SERVER_COMMAND, quit_command_len)) {
             break;
         }
...
int main(int argc, char* argv[]) {
    ...
    while (1) {
        /** INSERT CODE HERE TO ACCEPT AN INCOMING CONNECTION
         *
         * Suggestions:
         ...
         */        
         ...
         ERROR_HELPER(client_desc, "Couldn't accept client");
